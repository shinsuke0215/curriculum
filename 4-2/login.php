...
<html lang="ja">
    ...
    <body>
        <div class="wrap">
            <div class="header">
                <h2>ログイン画面</h2>
                <div class="btn1"><a href="signUp.php">新規ユーザー登録</a></div>
            </div>
            <form method="post" action="">
                <input type="text" name="name" placeholder="ユーザー名" size="30"><br><br>
                <input type="text" name="pass" placeholder="パスワード" size="30"><br><br>
